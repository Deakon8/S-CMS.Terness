...
<html lang="en">
<head>
	<title>Выбор категории | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading text-center"><h4>Выберите категорию, в которой должен находится создаваемый товар/услуга.</h4></div>
							</div>		
						</div>
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">Существующие категории
								<div class="right">Создать:
									<a href="new_cat.php"><span class="label label-info">Категорию</span></a>
									<a href="new_subcat.php"><span class="label label-info">Подкатегорию</span></a>
								</div>
								</div>
