...
<html lang="en">
<head>
	<title>Оформление новой поставки | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages2" class="collapse in">
								<ul class="nav">
									<li><a href="supply.php" class="active">История поставок</a></li>
							...
							<div class="col-md-2"></div>
								<div class="col-md-8">
									<div class="panel panel-default">
										<div class="panel-heading">Оформление поставки</div>
										<div class="panel-body">
											...
											<div class="col-md-12">
												...
												<hr>
												<div class="col-md-6">
													<span class="title">ID товара:</span>
													<input type="text" class="form-control" placeholder="#<?php sup_pid(); ?>" disabled>
													<input name="pID" type="hidden" value="<?php sup_pid(); ?>">
													<br>
												</div>
												<div class="col-md-6">
													<span class="title">Наименование товара:</span>
													<input type="text" class="form-control" placeholder="<?php sup_pname(); ?>" disabled>
													<input name="pName" type="hidden" value="<?php sup_pname(); ?>">
													<br>
												</div>
												<div class="col-md-6">
													<span class="title">Закупочная стоимость:</span>
													<input name="pCost" type="number" class="form-control">
													<br>
												</div>
												<div class="col-md-6">
													<span class="title">Размер поставки:</span>
													<input name="pAmount" type="number" class="form-control">
													<br>
												</div>
												<div class="col-md-6">
													<span class="title">Дата заказа:</span>
													<input name="oDate" type="date" class="form-control">
													<br>
												</div>
												<div class="col-md-6">
												...
												<div class="text-center"><h4>Информация о поставщике</h4></div>
												<hr>
												<div class="col-md-6">
													<span class="title">Фирма-поставшик:</span>
													<input name="sCompany" type="text" class="form-control">
													<br>
												</div>
												<div class="col-md-6">
													<span class="title">Оформлял поставку:</span>
										...
										<div class="panel-footer">
											<div class="row">
												...
												<div class="col-md-2">
													<button name="create_sup" type="submit" class="btn btn-primary btn-block">Оформить</button>
												</div>
												<div class="col-md-2">
													<a href="supply.php"><button type="button" class="btn btn-danger btn-block">Отменить</button></a>
												</div>
												<div class="col-md-4"></div>
											</div>
										</div>
