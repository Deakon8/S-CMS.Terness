...
<html lang="en">
<head>
	<title>Статистика | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="stat.php" class="active"><i class="lnr lnr-pie-chart"></i> <span>Статистика</span></a></li>
