...
<html lang="en">
<head>
	<title>Добавить новый товар | <?php print_companyname(); ?></title>
	<script>
    $("#prod").on("change", function() {
         if($("#prod")[0].files.length > 3); {
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="col-md-6">
											...
											<div class="col-md-6">
												...
												<input name="nameProduct" type="text" class="form-control" placeholder="Введите название товара" autocomplete="off" required>
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Стоимость:</span>
												<input name="cost" type="text" class="form-control" placeholder="Введите стоимость товара" autocomplete="off" required> 
												<br>
											</div>
											<div class="col-md-6">
												...
												<select name="pCondition" class="form-control">
													...
													<option value="Б/у с гарантией">Б/у с гарантией</option>
												</select>
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Размеры:</span>
												<input name="size" type="text" class="form-control" placeholder="Пример: 242 x 130 x 43 мм" autocomplete="off" required> 
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Гарантия:</span>
												<input name="warranty" type="text" class="form-control" placeholder="Пример: 36 месяцев" autocomplete="off" required> 
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Фото:</span>
												<input type="file" id="prod" name="uploadprod" class="form-control" accept="image/png" multiple required>
												<br>
											</div>
										</div>
										<!-- END FIRST COL -->
									...
									<div class="panel-footer">
										<div class="row">
											...
											<div class="col-md-2">
												<button name="create_prod" id="create_prod" type="submit" class="btn btn-primary btn-block">Добавить</button>
											</div>
											<div class="col-md-2">
