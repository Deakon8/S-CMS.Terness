...
<html lang="en">
<head>
	<title>Рассылка | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
						...
						<li>
							...
							<div id="subPages3" class="collapse in">
								<ul class="nav">
									...
									<li><a href="contact.php" class="active">Рассылка</a></li>
								</ul>
							</div>
						</li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">Массовая рассылка</div>
								<div class="panel-body">
									<span class="title">От кого:</span>
									<input type="text" class="form-control" placeholder="Интернет-магазин TERNESS" required disabled> 
									<br>
									...
									<input type="text" class="form-control" placeholder="Введите тему рассылки" required> 
									<br>
									<span class="title">Сообщение:</span>
									<textarea class="form-control" placeholder="Введите сообщение рассылки" rows="10" required></textarea>
								</div>
