...
<html lang="en">
<head>
	<title>Сотрудники | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Общий отчет по сотрудникам</h3>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-blue2 widget-icon"><i class="fa fa-users"></i></span>
										<p>
											<span class="number"><?php print_usersall(); ?></span>
											<span class="title">Всего сотрудников</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-red widget-icon"><i class="fa fa-user"></i></span>
										<p>
											<span class="number"><?php print_usersadm(); ?></span>
											<span class="title">Администраторов</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-purple widget-icon"><i class="fa fa-user"></i></span>
										<p>
											<span class="number"><?php print_usersmanager(); ?></span>
								...
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-green widget-icon"><i class="fa fa-user"></i></span>
										<p>
											<span class="number"><?php print_usersoperator(); ?></span>
											<span class="title">Операторов</span>
										</p>
									</div>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="panel-heading">Архив сотрудников
								<div class="right">
									<a href="new_emp.php"><span class="label label-info">Создать аккаунт</span></a>
