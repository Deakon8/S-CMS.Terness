...
<html lang="en">
<head>
	<title>Заказы | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Недельный отчет по заказам</h3>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-blue2 widget-icon"><i class="fa fa-shopping-bag"></i></span>
										<p>
											<span class="number"><?php print_ordersall(); ?></span>
								...
								<div class="col-md-3">
									<div class="metric">
										...
										<p>
											<span class="number"><?php print_ordersclosed(); ?></span>
											<span class="title">Завершенных</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-red widget-icon"><i class="fa fa-close"></i></span>
										<p>
											<span class="number"><?php print_orderscancel(); ?></span>
											<span class="title">Отменённых</span>
										</p>
									</div>
								</div>
								<div class="col-md-3">
									<div class="metric">
										<span class="icon widget-icon-blue widget-icon"><i class="fa fa-dollar"></i></span>
										<p>
											<span class="number">$<?php print_orderssum(); ?></span>
					...
					<div class="row">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Архив заказов
								<div class="right">
