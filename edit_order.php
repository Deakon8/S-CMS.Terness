...
<html lang="en">
<head>
	<title>Редактирование заказа | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="col-md-6">
											<div class="col-md-12">
												<div class="text-center"><h4>Товары из заказа</h4></div><hr>
												<?php edit_orderProd(); ?>
											</div>
											<div class="text-center"><h4>Информация о покупателе</h4></div><hr>
											<div class="col-md-6">
												<span class="title">ФИО:</span>
												<input name="cFullName_order" type="text" class="form-control" value="<?php edit_ordercfn(); ?>"> 
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Контактный номер:</span>
												<input name="cNumber_order" type="text" class="form-control" value="<?php edit_ordercnum(); ?>"> 
												<br>
											</div>
										</div>
										<!-- END FIRST COL -->
										...
										<div class="col-md-6">
											...
											<div class="col-md-6">
												...
												<input name="oid" type="text" class="form-control" placeholder="#<?php edit_orderid(); ?>" disabled> 
												<input name="id_order" type="hidden" class="form-control" value="<?php edit_orderid(); ?>"> 
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Заказ оформлен:</span>
												<select name="eid_order" class="form-control">
													<?php edit_ordereid(); ?>
												</select>
												<br>
											</div>
											<div class="col-md-6">
												...
												<select name="deliveryMethod_order" class="form-control">
													<?php edit_orderdm(); ?>
												</select>
												<br>
											</div>
											<div class="col-md-6">
												...
												<input name="deliveryAdress_order" type="text" class="form-control" value="<?php edit_orderda(); ?>"> 
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Дата заказа:</span>
												<input name="reg_order" type="text" class="form-control" placeholder="<?php edit_orderreg(); ?>" disabled> 
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Дата доставки:</span>
												<input name="delivery_order" type="date" class="form-control" value="<?php edit_orderdelivery(); ?>"> 
												<br>
											</div>
										</div>
										<!-- END SECOND COL -->
									...
									<div class="panel-footer">
										<div class="row">
											...
											<div class="col-md-2">
												<button name="edit_order" type="submit" class="btn btn-primary btn-block">Редактировать</button>
											</div>
											<div class="col-md-2">
												<a href="orders.php"><button type="button" class="btn btn-danger btn-block">Отменить</button></a>
											</div>
											<div class="col-md-4"></div>
										</div>
									</div>
