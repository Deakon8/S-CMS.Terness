...
<html lang="en">
<head>
	<title>Создать новую категорию | <?php print_companyname(); ?></title>
	<meta charset="utf-8">
						...
						<form method="post" action="assets/scripts/global_func.php">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Создание новой категории</div>
									<div class="panel-body">
										...
										<div class="col-md-12">
											...
											<hr>
											<div class="col-md-6">
												<span class="title">ID Категории:</span>
												<input type="text" class="form-control" placeholder="ID категории" disabled>
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Название категории:</span>
												<input name="create_cat_name" type="text" class="form-control" placeholder="Введите название категории" required>
												<br>
											</div>
											<div class="col-md-12">
												<span class="title">Описание категории:</span>
												<textarea name="create_cat_desc" class="form-control" placeholder="Введите описание категории" rows="5"></textarea>
												<br>
											</div>
										</div>
										<!-- END FIRST COL -->
									...
									<div class="panel-footer">
										<div class="row">
											...
											<div class="col-md-2">
												<button name="create_cat" type="submit" class="btn btn-primary btn-block">Создать</button>
											</div>
											<div class="col-md-2">
