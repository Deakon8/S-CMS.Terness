...
<html lang="en">
<head>
	<title>Редактирование подкатегории | <?php print_companyname(); ?></title>
	<!-- DYNAMIC INPUT -->
								...
								<div class="panel panel-default">
										...
										<div class="col-md-6">
											...
											<div class="col-md-6">
												...
												<select name="category" class="form-control"> 
													<?php edit_subcat_category(); ?>
												</select>
												<br>
											</div>
											<div class="col-md-6">
												<span class="title">Название подкатегории:</span>
												<input name="subCategory" type="text" class="form-control" value="<?php edit_subcat_subCategory(); ?>">
												<br>
											</div>
											<div class="col-md-12">
												<span class="title">Описание подкатегории:</span>
												<textarea name="description" class="form-control" rows="5"><?php edit_subcat_description(); ?></textarea>
												<br>
												<hr>
											</div>
										</div>
									...
									<div class="panel-footer">
										<div class="row">
											...
											<div class="col-md-2">
												<button name="edit_subcat" type="submit" class="btn btn-primary btn-block">Редактировать</button>
											</div>
											<div class="col-md-2">
